...
class _BaseData:
    ...
    def _process_for_pycox(self):
        def _get_data(df):
            ...
            #  See line 151-155 for more information.
...
class Baselines(_BaseModel):
    ...
    def __init__(self, algorithm, data, n_trees=None, n_neurons=None, dropout=0):
        ...
        if self.algorithm == 'RSF':
            ...
            model_factory_args['dropout'] = dropout
    ...
    def fit(self, min_node_size=50, **kwargs):
        if self.algorithm == 'CPH':
            ...
            ''' I have changed this fit function because the last two columns 
                instead of the first two are the survival information.
                Specifically, the data is arranged in a form of [x1, x2, ... , xn, time, event]
                while the original code assumed a form of [time, event, x1, x2, ..., xn] '''
